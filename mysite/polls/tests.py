...
def create_question(question_text, days):
    ...
    questions published in the past, positive for question 
    that have yet to be publihsed).
    """
...
class QuestionMethodTests(TestCase):
    ...
    def test_index_view_with_no_question(self):
        """
        If no questions exits, an appropriate message should be displayed.
        """
    ...
    def test_index_view_with_a_past_question(self):
        """
        Questions with a pub_date in the past whsould be desplayed on
        the index page.
        """
    ...
    def test_was_published_recently_with_recent_question(self):
        """
        wad_published_recently() should return True for question whose
